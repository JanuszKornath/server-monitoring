...
# Der gesamte Ablauf steckt in main(), damit die Ausgabe durch eine Pipeline
# laufen kann. Die Shell wartet auf das letzte Glied einer Pipeline, sodass
# beim Skriptende keine Zeilen mehr offen im Puffer stehen.
main() {
    HOSTNAME=$(hostname)
...
# Jede Ausgabezeile mit Zeitstempel versehen (für Cron-Logs)
